...
# return a list of tuples (name, size)
...
# main program
# dsn_hostname = "172.18.0.2"
# dsn_uid = "db2inst1"
# dsn_pwd = "db2inst1"
# dsn_driver = "{ibm db2 odbc driver}"
# dsn_database = "dochadr"
# dsn_port = "50000"
# dsn_protocol = "tcpip"

driver = '{IBM DB2 ODBC DRIVER}'  # Db2 driver information
host = '172.18.0.2'  # database host IP or dns address
...
if pw == None or pw == '':
    ...
    exit(-1)
conn_str = 'DRIVER=' + driver + ';HOSTNAME=' + host + ';PORT=' + port \
    + ';DATABASE=' + db + ';UID=' + uid + ';PWD=' + pw
...
sqlstmt = 'select * from department limit 1'
try:
